...
class LR():
    ...
    def __init__(self,
        ...
        self.polynomial_converter = PolynomialFeatures(degree=self.degree, include_bias=False)
        self.poly_features = self.polynomial_converter.fit_transform(X)

        # Train-test split
        self.X_train, self.X_test, self.y_train, self.y_test = train_test_split(self.poly_features,
                                                                                self.y,
